...
import torch
import pickle
from booknlp.english.modern_qa import GraphQuotationAttribution
...
class EnglishBookNLP:
    ...
    def __init__(self, model_params):
        ...
        with torch.no_grad():
            ...
            if 'modern_qa' not in model_params : 
                model_params['modern_qa'] = False 
            ...
            # default to joint scoring
            if 'direct_qa' not in model_params : 
                model_params['direct_qa'] = False
            ...
            if self.doQuoteAttrib:
                if model_params['modern_qa'] : 
                    self.quote_attrib=GraphQuotationAttribution(is_direct=model_params['direct_qa'])
                else : 
